  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-slate-900 font-sans flex flex-col items-center">
      ...
      <div className="flex-1 w-full mx-auto p-6 md:p-8 flex flex-col lg:flex-row gap-8 z-10 h-[calc(100vh-200px)]">
        ...
        {/* Left Half: TCKT */}
        <div className="lg:w-1/2 flex flex-col gap-3 bg-gradient-to-br from-blue-900/80 to-indigo-900/80 backdrop-blur-2xl rounded-[3rem] border border-blue-400/30 shadow-[0_0_50px_rgba(37,99,235,0.2)] p-6 pt-4">
          <div className="flex justify-center -mt-2 -mb-4">
            <img src="/assets/title_k71.png" alt="TCKT" className="w-full max-w-[90%] h-auto object-contain drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]" />
          </div>
          
          {/* Moving */}
          <div className="flex-1 flex flex-col gap-4 overflow-y-auto custom-scrollbar pr-2 border-t border-blue-500/30 pt-4">
          ...
          {/* Waiting */}
          <div className="flex-[1.2] bg-slate-900/40 rounded-3xl p-6 flex flex-col overflow-hidden">
        ...
        {/* Right Half: BCS */}
        <div className="lg:w-1/2 flex flex-col gap-3 bg-gradient-to-br from-emerald-900/80 to-teal-900/80 backdrop-blur-2xl rounded-[3rem] border border-emerald-400/30 shadow-[0_0_50px_rgba(16,185,129,0.2)] p-6 pt-4">
          <div className="flex justify-center -mt-2 -mb-4">
            <img src="/assets/title_bcs.png" alt="BCS" className="w-full max-w-[90%] h-auto object-contain drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]" />
          </div>
          
          {/* Moving */}
          <div className="flex-1 flex flex-col gap-4 overflow-y-auto custom-scrollbar pr-2 border-t border-emerald-500/30 pt-4">
